...
$PayloadDirs = @("docs",".agents/skills",".agents/memory",".agents/workflows",".agents/harness",".agents/rules",".agents/agents",".agents/feedback/templates","scripts","src","tests",".muse")
